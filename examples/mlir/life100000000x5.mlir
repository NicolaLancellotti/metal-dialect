module  {
  ...
  func @main() -> i32 {
    ...
    %2 = metal.device_make_buffer %0, %false, %c500000000_i64, %c4_i64 : (index, i1, i64, i64) -> index
    %3 = metal.device_make_buffer %0, %false, %c2_i64, %c4_i64 : (index, i1, i64, i64) -> index
    %4 = metal.device_make_buffer %0, %false, %c500000000_i64, %c4_i64 : (index, i1, i64, i64) -> index
    %5 = metal.command_queue_make_command_buffer life %1, %c100000000_i64, %c5_i64, %c1_i64: (index, i64, i64, i64) -> index
    ...
    store %c100000000_i32, %7[%c0] : memref<?xi32>
    store %c5_i32, %7[%c1] : memref<?xi32>
