module {
  ...
  func.func @main() -> i32 {
    ...
    %c100000000_i32 = arith.constant 100000000 : i32
    %c5_i32 = arith.constant 5 : i32
    %c100000000_i64 = arith.constant 100000000 : i64
    %c5_i64 = arith.constant 5 : i64
    %c500000000_i64 = arith.constant 500000000 : i64
    ...
    memref.store %c100000000_i32, %7[%c0] : memref<?xi32>
    memref.store %c5_i32, %7[%c1] : memref<?xi32>
