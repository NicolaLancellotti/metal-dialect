module  {
  ...
  func @main() -> i32 {
    ...
    %c49_i32 = constant 49 : i32
    %c48_i32 = constant 48 : i32
    ...
    store %c1_i32, %6[%c0] : memref<?xi32>
    store %c1_i32, %6[%c1] : memref<?xi32>
    store %c1_i32, %6[%c2] : memref<?xi32>
    store %c1_i32, %6[%c3] : memref<?xi32>
    %7 = metal.buffer_get_contents %3 : (index) -> memref<?xi32>
    store %c5_i32, %7[%c0] : memref<?xi32>
    store %c5_i32_0, %7[%c1] : memref<?xi32>
    ...
    %9 = alloca() : memref<i32>
    %10 = alloca() : memref<i32>
    store %c-1_i32, %9[] : memref<i32>
    br ^bb1
  ^bb1:  // 2 preds: ^bb0, ^bb6
    %11 = load %9[] : memref<i32>
    %12 = addi %11, %c1_i32 : i32
    store %12, %9[] : memref<i32>
    %13 = load %9[] : memref<i32>
    %14 = cmpi slt, %13, %c5_i32 : i32
    cond_br %14, ^bb2, ^bb3
  ^bb2:  // pred: ^bb1
    store %c-1_i32, %10[] : memref<i32>
    br ^bb4
  ^bb3:  // pred: ^bb1
    ...
    return %c0_i32 : i32
  ^bb4:  // 2 preds: ^bb2, ^bb5
    %15 = load %10[] : memref<i32>
    %16 = addi %15, %c1_i32 : i32
    store %16, %10[] : memref<i32>
    %17 = load %10[] : memref<i32>
    %18 = cmpi slt, %17, %c5_i32_0 : i32
    cond_br %18, ^bb5, ^bb6
  ^bb5:  // pred: ^bb4
    %19 = load %9[] : memref<i32>
    %20 = muli %19, %c5_i32_0 : i32
    %21 = load %10[] : memref<i32>
    %22 = addi %20, %21 : i32
    %23 = index_cast %22 : i32 to index
    %24 = load %8[%23] : memref<?xi32>
    %25 = cmpi eq, %24, %c1_i32 : i32
    %26 = select %25, %c49_i32, %c48_i32 : i32
